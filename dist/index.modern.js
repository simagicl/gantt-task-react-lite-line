...
var GridBody = function GridBody(_ref) {
  ...
  var tickX = 0;
  var ticks = [];
  var today = React.createElement("g", null);
  var todayLineX = 0;
  for (var i = 0; i < dates.length; i++) {
    ...
    if (i + 1 !== dates.length && date.getTime() < now.getTime() && dates[i + 1].getTime() >= now.getTime() || i !== 0 && i + 1 === dates.length && date.getTime() < now.getTime() && addToDate(date, date.getTime() - dates[i - 1].getTime(), "millisecond").getTime() >= now.getTime()) {
      ...
      today = React.createElement("g", null, React.createElement("rect", {
        x: tickX,
        y: 0,
        width: columnWidth,
        height: y,
...
var Project = function Project(_ref) {
  ...
  }), task.name !== "TRAMITACIÓN" && React.createElement(React.Fragment, null, React.createElement("rect", {
    fill: barColor,
    x: task.x1,
    width: projectWidth,
    y: task.y,
...
var TaskItem = function TaskItem(props) {
  ...
  }, taskItem, !isProgressComplete && React.createElement("text", {
    x: getX(),
